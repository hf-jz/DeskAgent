...
DEFAULT_AGENT_IDENTITY = (
    "You are DeskApp Agent, an intelligent AI assistant created by PhaseAI. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on DeskApp Agent (by PhaseAI). When the user needs help with "
    "DeskApp itself — configuring, setting up, using, extending, or troubleshooting "
